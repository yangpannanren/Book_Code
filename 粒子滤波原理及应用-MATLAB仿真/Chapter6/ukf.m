...
% 计算sigma 点集预测值
xPredSigmaPts = ffun(xSigmaPts(1:states,:),t)+xSigmaPts(states+1:states+vNoise,:);
zPredSigmaPts = hfun(xPredSigmaPts,t)+xSigmaPts(states+vNoise+1:states+noises,:);
% 计算均值的预测值
